...
- 内申点の値（教科・倍率・満点・比率・ESAT-J の点数化・加算点）と出典は `lib/naishin-values.js`（`CHECKED`）。令和9年度（2027 年 4 月入学）の要綱: 東京都（2026-09-17 公表）・神奈川県（2026-07-01 更新）・兵庫県（2026-09-03 掲載）
...
| 時期 | 確認すること | 直す場所 |
|------|------------|---------|
| 毎年 9 月ごろ | 東京都・神奈川県・兵庫県の次の年度の入学者選抜の要綱（比率、7:3 と 10:0 の学校、ESAT-J、加算点） | `lib/naishin-values.js`（`year`・`CHECKED`・`ratios`・`bestSchools`・`kasan`・出典の URL）、`tests/naishin.test.js`、`naishin/guide.html` |
